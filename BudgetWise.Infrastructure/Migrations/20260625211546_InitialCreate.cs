...
namespace BudgetWise.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SinkingFundContributions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SinkingFundId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BudgetPlanId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SinkingFundContributions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SinkingFundContributions_BudgetPlans_BudgetPlanId",
                        column: x => x.BudgetPlanId,
                        principalTable: "BudgetPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SinkingFundContributions_SinkingFunds_SinkingFundId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetPlans_UserId_Month_Year",
                table: "BudgetPlans",
                columns: new[] { "UserId", "Month", "Year" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SinkingFundContributions_BudgetPlanId",
                table: "SinkingFundContributions",
                column: "BudgetPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_SinkingFundContributions_SinkingFundId",
                table: "SinkingFundContributions",
